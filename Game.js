class Game extends Phaser.Scene {
    ...
    create() {
        ...
        this.planetImage.on('pointerdown', function() {
            count++;
            if (count == 1) {
                this.vectorimage1 = this.add.image(450, 300, "vector1").setScale(0.2);
                this.vectorimage4 = this.add.image(450, 300, "vector4").setScale(0.2);
                x = true;
            } else if (count == 2) {
                this.planetImage.setAlpha(0)
                this.fingerasset.setAlpha(0);
                this.textTap.setAlpha(0);
                this.vectorimage1 = this.add.image(450, 300, "vector1").setScale(0.35);
                this.vectorimage2 = this.add.image(450, 300, "vector4").setScale(0.2);
                this.vectorimage5 = this.add.image(450, 300, "vector1").setScale(0.35);
                this.vectorimage6 = this.add.image(450, 300, "vector4").setScale(0.2);
                x = true;
                setTimeout(function() {
                    startScene = true;
                }, 500);
